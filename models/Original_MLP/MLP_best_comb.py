...
data = pd.read_csv("data_superstar_v1_0_original_netmet.csv", delimiter=",", dtype=dtype_dict, na_values=[''])
...
columns_to_keep = ['explicit', 'track_number', 'num_artists', 'num_available_markets', 'release_date',
                   ...
                   'hit', 'betweenesscentrality_x', 'closnesscentrality_x', 'clustering_x', 'Cluster_x',
                    'eccentricity_x', 'eigencentrality_x', 'weighted degree_x', "profile_x", "pagerank_x", "pagerank_y"]
...
best_val_acc = 0
best_precision = 0
version = "v3_best_comb_original_netmet_0_0001_noyoc"
