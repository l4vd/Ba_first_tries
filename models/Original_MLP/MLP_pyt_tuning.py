...
def run(additional_features, version, optim_c="adam", lr=0.001, epochs=200, device="cpu"):
    dtype_dict = {
        'song_id': str,
        'song_name': str,
    ...
    for epoch in range(epochs):  # Adjust epochs as needed
        ...
        with torch.no_grad():
            ...
            if epoch_val_prec > best_precision or epoch == 0:
...
if __name__ == "__main__":
    ...
    input_dict['eigencentrality_x'] = float
    input_dict['eccentricity_x'] = float
    input_dict['degree_x'] = float
    input_dict['clustering_x'] = float
    input_dict['closnesscentrality_x'] = float
    input_dict['weighted degree_x'] = float
    input_dict['betweenesscentrality_x'] = float
    input_dict['Cluster_x'] = float
    i = 0
    for lr in learning_rate:
        for optim_c in optim_choice:
            ...
            run(input_dict, version=version, optim_c=optim_c, lr=lr, epochs=100, device=device)
