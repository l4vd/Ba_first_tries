    ...
    with torch.no_grad():
        ...
        if epoch_val_loss < best_val_loss:
            ...
            torch.save({
                ...
                'loss': epoch_val_loss,
            }, f'best_model_{version}_min_val_loss.pth')
        if epoch_val_acc > best_val_acc:
            ...
            torch.save({
                ...
                'optimizer_state_dict': optimizer.state_dict(),
                'loss': val_loss,
            }, f'best_model_{version}_max_val_acc.pth')
        if epoch_val_prec > best_precision:
            ...
            }, f"best_model_{version}_max_val_prec.pth")
...
print("######LOAD MODEL######")
model = MLPClassifier(X_train.size()).to(device)
model = load_model(model, f"best_model_{version}_max_val_prec.pth")
